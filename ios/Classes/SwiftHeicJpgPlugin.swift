...
public class SwiftHeicJpgPlugin: NSObject, FlutterPlugin {
  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(name: "heic_jpg", binaryMessenger: registrar.messenger())
    let instance = SwiftHeicJpgPlugin()
